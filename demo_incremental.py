...
def demo_incremental_ingestion():
    ...
    print("  ✓ Detect modified files")
    print("  ✓ Force re-ingestion option")
    print("  ✓ Metadata enrichment with file hash")
    print("\n💡 To use with real ingestion:")
    print("  python ingest.py --docs-dir /path/to/docs")
    print("  python ingest.py --docs-dir /path/to/docs --reingest")
    print()
