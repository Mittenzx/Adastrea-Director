...
def fix_unicode_in_file(filepath: Path):
    ...
    try:
        ...
        # Also handle the variation selector (️) that sometimes follows emojis
...
def main():
    ...
    print("\n" + "=" * 60)
    print("Done! All Unicode emojis replaced with ASCII equivalents.")
    print("\nNote: This makes the output compatible with Windows terminals")
    print("      that don't support Unicode emojis.")
